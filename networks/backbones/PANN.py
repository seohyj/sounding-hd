...
from networks.backbones.pann_utils import do_mixup, interpolate, pad_framewise_output
...
class Cnn14_nontemp(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, 
        fmax, classes_num):
        
        super(Cnn14_nontemp, self).__init__()
...
class Cnn14_temp(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, 
        fmax, classes_num):
        
        super(Cnn14_temp, self).__init__()
